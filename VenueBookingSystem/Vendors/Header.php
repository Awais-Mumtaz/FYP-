    ...
    <div class="modal-content shadow-lg">
      ...
      <div class="modal-body">
        <form action="./Login.php" method="post">
          ...
          <p>New vendor <b><a id="register-btn" href="./Register.html" data-toggle="modal" data-target="#RegisterModal">Register</a></b> Here.</p>
      </form>
      </div>
    ...
    <div class="modal-content shadow-lg">
      ...
      <div class="modal-body">
        <form action="./Register.php" method="post">
          ...
          <button type="submit" class="btn btn-outline-success form-control mt-2">Register</button>
          <p>Already Have An Account <b><a id="login-btn" data-toggle="modal" data-target="#LoginModal" href="./Login.html">Log-In</a></b> Here.</p>
      </form>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-outline-danger" data-dismiss="modal">Close</button>
  ...
  <nav class="navbar navbar-expand-sm navbar-light bg-light">
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavId">
        ...
        <?php
          ...
          echo '<button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="#LoginModal">Log-in</button>';
          }
        ?>
      </div>
  </nav>