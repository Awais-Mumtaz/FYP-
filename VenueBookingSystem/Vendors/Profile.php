...
if (isset($_POST['vendor_name'])) {
    ...
    $sql = "UPDATE vendors SET name = '" . $uname . "', email = '" . $uemail . "', date_of_birth = '" . $udob . "' WHERE id= '" . $uid . "'";
    $result = mysqli_query($connection, $sql);
    if ($result) {
        $_SESSION["vendorname"]= $uname;
...
if(isset($_POST['upload_btn'])){
    ...
    if(copy($_FILES['imageupload']['tmp_name'], "../Includes/uploads/" .$newfilename)){
        ...
        $updateprofileid = "UPDATE vendors SET image = '".$profileresults['id']."' WHERE id = $userid";
...
<div class="page-content p-5" id="content">
    ...
    $sql = "SELECT * FROM vendors WHERE id='" . $vendorid . "' LIMIT 1";
                    ...
                    <form action="./Profile.php" method="POST" class="col-md-8">
                        <div class="p-3 py-5">
                            ...
                            <div class="row mt-3 input-group ">
                                ...
                                name="vendor_name" placeholder="Full Name" value="<?php echo $row["name"] ?>">
                            </div>
                            ...
                            <div class="row mt-3 input-group ">
                                ...
                                name="vendor_email" placeholder="Email" value="<?php echo $row["email"] ?>">
                                </div>
                            ...
                            name="vendor_dob" placeholder="date-of-birth" value="<?php echo $row["date_of_birth"] ?>">
                            </div>
